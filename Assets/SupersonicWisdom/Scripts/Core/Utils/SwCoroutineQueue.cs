...
namespace SupersonicWisdomSDK
{
    ...
    public class SwCoroutineQueue
    {
        ...
        public void Run(IEnumerator coroutine)
        {
            ...
            {
                SwInfra.Logger.Log("SwCoroutineQueue | enqueue coroutine");
        ...
        {
            _numActive++;
            SwInfra.Logger.Log($"$SwCoroutineQueue | active coroutines {_numActive}");
            ...
            if (queue.Count > 0)
            {
                ...
                Run(next);
                SwInfra.Logger.Log("$SwCoroutineQueue | dequeue coroutine");
            }
        }
