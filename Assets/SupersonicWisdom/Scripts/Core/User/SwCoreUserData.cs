...
{
    internal class SwCoreUserData : ISwUserData
    {
        #region --- Constants ---
        ...
        public string InstallDate
        {
            ...
            {
                _installDate = value;
                SwInfra.KeyValueStore.SetString(SwStoreKeys.InstallDate, _installDate);
                SwInfra.KeyValueStore.Save();
            }
        }
        ...
        public SwCoreUserData(ISwSettings settings, ISwAdvertisingIdsGetter idsGetter)
        {
            Settings = settings;
        ...
        private void LoadInstallDate()
        {
            ...
            IsNew = string.IsNullOrEmpty(InstallDate);
